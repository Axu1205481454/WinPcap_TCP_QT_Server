...
QT_MOC_LITERAL(8, 100, 13), // "recvMsgSignal"
QT_MOC_LITERAL(9, 114, 16), // "packetStaticSlot"
QT_MOC_LITERAL(10, 131, 20), // "connStatusStaticSlot"
QT_MOC_LITERAL(11, 152, 11) // "recvMsgSlot"

    },
    "PacketHandle\0packetSignal\0\0info\0"
    "packetStaticSignal\0connStatusSignal\0"
    "connFlag\0connStatusStaticSignal\0"
    "recvMsgSignal\0packetStaticSlot\0"
    "connStatusStaticSlot\0recvMsgSlot"
};
...
void PacketHandle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->recvMsgSignal(); break;
        case 5: _t->packetStaticSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 6: _t->connStatusStaticSlot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 7: _t->recvMsgSlot(); break;
        default: ;
        }
        ...
        {
            using _t = void (PacketHandle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PacketHandle::recvMsgSignal)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void PacketHandle::recvMsgSignal()
{
